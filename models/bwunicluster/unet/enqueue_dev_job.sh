...
#SBATCH --time=0:30:00
#SBATCH --gres=gpu:2
#SBATCH --export=ALL,EXECUTABLE="python ../../../src/trainers/trainer.py --epochs=500 --batch_size=15 --save=True --dataset_path=resources/images/calibrated/3d_aligned --dir_checkpoint=resources/models/calibrated/3d_aligned"
