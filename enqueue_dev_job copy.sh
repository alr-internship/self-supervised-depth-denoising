...
#SBATCH --export=ALL,EXECUTABLE="src/dataset/generate_sets.py resources/images/calibrated_masked/not-cropped/ycb_video"
#SBATCH --output="tmp_sets.out"
#SBATCH -J Tmp2
#SBATCH --dependency=afterany:20472047
